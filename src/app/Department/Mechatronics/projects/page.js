...
const MechatronicsProjectsPage = () => {
  ...
  const fetchProjects = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/project?type=cse&page=${page}&limit=${limit}`
      );
...
export default MechatronicsProjectsPage;