...
const MechatronicsConferencePage = () => {
  ...
  const fetchPublications = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/conference?type=mae&page=${page}&limit=${limit}`
      );
...
export default MechatronicsConferencePage;